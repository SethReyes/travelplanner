...
function Day({dayNum, dayList, setDays, dayID, setAll}){
    ...
    <DayContainer>
        ...
        <LocationContainer>
            {locationList.map(loc => {
                return (<Location key={loc.locID} locID={loc.locID} location={loc.locName} setLocations={setLocations} locList={locationList} dayNum={dayNum} setAll={setAll}/> )       
            })}
